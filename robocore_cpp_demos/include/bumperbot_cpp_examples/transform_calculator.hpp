...
#include "robocore_interfaces/srv/get_transform.hpp"
...
private: 
    ...
    bool getTransformCallback(const std::shared_ptr<robocore_interfaces::srv::GetTransform::Request> req,
                              const std::shared_ptr<robocore_interfaces::srv::GetTransform::Response> res);

    rclcpp::TimerBase::SharedPtr timer_;
    rclcpp::Service<robocore_interfaces::srv::GetTransform>::SharedPtr get_transform_srv_;
