...
int main(int argc, char * argv[]) {
  ...
  std::shared_ptr<SimpleLifecycleNode> lifecycle_manager =
    std::make_shared<SimpleLifecycleNode>("lifecycle_manager");

  ste.add_node(lifecycle_manager->get_node_base_interface());
  ste.spin();
  rclcpp::shutdown();
