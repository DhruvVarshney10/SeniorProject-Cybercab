#include "robocore_control/filtered_controller.hpp"
                                  ...
                                  , theta_(0.0)
{
    ...
    odom_pub_ = create_publisher<nav_msgs::msg::Odometry>("/robocore_control/odom_noisy", 10);
...
int main(int argc, char* argv[])
{
  ...
  auto node = std::make_shared<NoisyController>("filtered_controller");
  rclcpp::spin(node);
  rclcpp::shutdown();
  return 0;
}